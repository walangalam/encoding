...
const ID=1, NAME='alyxvoice', URL='wss://ramurgamefix.com/alyx-g2-voice', BRIDGE_TOKEN='5002e7cebd2272e26a25f0269adfa468eca6c15d4eea699e'
...
function text(){const body=reply||partial||finalText||'Say “Alyx…” or press temple';return ['ALYX VOICE 0.2.1',`NET:${ws?.readyState===1?'OK':'--'} MIC:${mic?'ON':'OFF'} ${mode.toUpperCase()}`,`STATE:${state}`,body.slice(-190),`frames:${frames} press:${press}`].join('\n')}
